...
<head>
  ...
  <meta name="description" content="Vježba2b — nastavak na vjezba2a.php">
...
<body>
  <main class="wrap">
    ...
    <div class="row">
      ...
      <a class="btn" href="<?php echo $linkNatrag; ?>">Natrag na vježba 2a</a>
    </div>
